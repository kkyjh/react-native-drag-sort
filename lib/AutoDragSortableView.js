...
export default class AutoDragSortableView extends Component{
    ...
    endTouch (nativeEvent) {
        ...
        if (this.touchCurItem) {
            ...
            Animated.parallel([
                Animated.timing(this.state.dataSource[this.touchCurItem.index].opacity, {
                  toValue: 1,
                  duration: this.props.scaleDuration,
                  useNativeDriver: false,
                }),
            ...
            return (
                <Animated.View
                    ...
                    style={[styles.item,{
                        ...
                        zIndex: fixedItems.length > 0 && fixedItems.includes(index) ? defaultZIndex - 1 : defaultZIndex,
                    }]}>
                    <TouchableOpacity
                        activeOpacity = {1}
