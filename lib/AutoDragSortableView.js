...
export default class AutoDragSortableView extends Component {
  constructor(props) {
    ...
    const dataSource = props.dataSource.map((item, index) => {
      ...
      newData.opacity = new Animated.Value(1);
      return newData;
    });
    this.state = {
  ...
  startTouch(touchIndex) {
    ...
    if (this.sortRefs.has(key)) {
      ...
      Animated.parallel([
        Animated.timing(this.state.dataSource[touchIndex].opacity, {
          toValue: 0,
  ...
  endTouch(nativeEvent) {
    ...
    if (this.touchCurItem) {
      ...
      Animated.parallel([
        Animated.timing(
          this.state.dataSource[this.touchCurItem.index].opacity,
          {
            toValue: 1,
            duration: this.props.scaleDuration,
            useNativeDriver: false,
        ...
        <View
          ...
          style={[
            styles.swipe,
            {
              ...
              marginTop: this.props.parentMarginTop,
              marginBottom: this.props.parentMarginBottom,
              marginLeft: this.props.parentMarginLeft,
              marginRight: this.props.parentMarginRight,
            },
          ]}
          //onLayout={()=> {}}
        >
        ...
        <Animated.View
          ...
          style={[
            styles.item,
            {
              ...
              zIndex:
                fixedItems.length > 0 && fixedItems.includes(index)
                  ? defaultZIndex - 1
                  : defaultZIndex,
            },
          ]}
        >
          ...
          >
            ...
            <Animated.View style={{ opacity: item.opacity }}>
              {this.props.renderSubItem &&
                this.props.renderSubItem(item.data, index)}
            </Animated.View>
          </TouchableOpacity>
        </Animated.View>
      );
...
AutoDragSortableView.propTypes = {
  ...
  parentMarginTop: PropTypes.number,
  parentMarginBottom: PropTypes.number,
  parentMarginLeft: PropTypes.number,
  parentMarginRight: PropTypes.number,
